...
3. Asks you **one consolidated question** for whatever it couldn't discover — and always asks before running benchmark load against shared infrastructure (staging databases, triple stores).
